...
public class Play implements Screen, ControllerListener {
	...
	public boolean povMoved(Controller controller, int povCode, PovDirection value) {
		...
		/*
		 * switch(value){ case east:{ movePlayerToLeft = false;
		 * movePlayerToRight = true; break; } case west:{ movePlayerToLeft =
		 * true; movePlayerToRight = false; break; } default: break; } return
		 * false;
		 */
		return false;
	}
